...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 14,445 | 🐛 3,486 | 🌐 C | 📅 2026-02-11 - Zephyr
* [Matter](https://github.com/project-chip/connectedhomeip) ⭐ 8,572 | 🐛 2,618 | 🌐 C++ | 📅 2026-02-12 - Matter
...
* [SimpleBLE](https://github.com/OpenBluetoothToolbox/SimpleBLE) ⭐ 1,032 | 🐛 73 | 🌐 C++ | 📅 2026-02-10 - The all-in-one C/C++/Python/Rust Bluetooth LE library for MacOS, iOS, Windows, and Linux.
* [pygatt](https://github.com/peplin/pygatt) ⭐ 534 | 🐛 30 | 🌐 Python | 📅 2024-08-03 - A Python library for interacting with BLE devices.
* [bumble](https://github.com/google/bumble) ⭐ 476 | 🐛 67 | 🌐 Python | 📅 2026-02-11 - Bumble is a full-featured Bluetooth stack written entirely in Python.
...
* [Kable](https://github.com/JuulLabs/kable) ⭐ 1,124 | 🐛 57 | 🌐 Kotlin | 📅 2026-02-11 - Kotlin Asynchronous Bluetooth Low Energy provides a simple Coroutines-powered API for interacting with Bluetooth Low Energy devices.
...
* [FastBle](https://github.com/Jasonchenlijian/FastBle) ⭐ 5,473 | 🐛 246 | 🌐 Java | 📅 2022-07-27 - An Android Bluetooth Low Energy (BLE) fast development framework.
...
* [Nordic Semiconductor BLE SDK for Android](https://github.com/NordicSemiconductor/Android-BLE-Library) ⭐ 2,331 | 🐛 45 | 🌐 Java | 📅 2026-02-05 - Official Bluetooth Low Energy SDK provided by Nordic Semiconductor for Android development.
...
* [Flutter Blue Plus](https://github.com/boskokg/flutter_blue_plus) ⭐ 981 | 🐛 14 | 🌐 Dart | 📅 2025-12-29 - Flutter Blue Plus is a bluetooth plugin for Flutter, a new app SDK to help developers build modern multi-platform apps.
...
* [Flutter BLELib](https://github.com/dotintent/FlutterBleLib) ⭐ 551 | 🐛 122 | 🌐 Dart | 📅 2024-07-29 - Bluetooth Low Energy library for Flutter with support for simulating peripherals.

## Tool

*Development and testing tools for Bluetooth Low Energy (BLE) applications, including analyzers, debuggers, and simulators.*

* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 18,827 | 🐛 45 | 🌐 Go | 📅 2025-12-31 - A easily extensible and portable framework for security researchers to test BLE security.
* [nRF Connect](https://github.com/NordicSemiconductor/pc-nrfconnect-core) ⭐ 207 | 🐛 10 | 🌐 TypeScript | 📅 2026-02-11 - An application framework for developing, testing, and provisioning devices based on Nordic Semiconductor chips.
...
* [ESP-IDF](https://github.com/espressif/esp-idf) ⭐ 17,308 | 🐛 1,527 | 🌐 C | 📅 2026-02-09 - Espressif IoT Development Framework
